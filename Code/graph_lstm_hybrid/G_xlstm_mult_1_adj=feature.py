...
class GraphXLSTMBranch(nn.Module):
    def __init__(
        ...
        for _ in range(graph_layers):
            self.graph_layers.append(GraphLayer(num_channels, in_features, graph_hidden, dropout))
...
def main():
    ...
    all_loader = DataLoader(MultiScaleFeatureDataset(branches, labels), batch_size=batch_size)
